...
│   ├── integrations/          # External clients: Exa, Fal, Composio, BrowserUse, MCP manager
...
| External integrations | `packages/integrations/src/` | MCP, Exa, Fal, Composio, BrowserUse |
...
- **Optional features**: Integrations toggle on when their API keys are present. Exa, Fal, Composio, STT, and TTS capabilities should not be exposed to LLMs unless configured and actually wired.
